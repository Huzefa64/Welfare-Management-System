...
font-family:"Times New Roman","serif"'>Social welfare members</span></b></p>

<p class=msoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:7.0pt;
font-family:"Times New Roman","serif"'>Powered by Social welfare manager <?php
 $date = new DateTime();
 echo $date->format('Y');
 ?></span></b></p>
...
<table class=msoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:23.25pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
   ...
   <!-- mysqli FETCH ARRAY-->
<?php
		$student_query = mysqli_query($conn,"select * from members INNER JOIN offering ON members.mobile=offering.na ")or die(mysqli_error());
