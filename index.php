...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Social Welfare MANAGER</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
        <meta name="description" content="Social Welfare Manager" />
        <meta name="keywords" content="Social Welfare, Manager, Member registration, Donations, Donations Manager" />
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>Social Welfare MANAGER <span>ACCESS POINT</span></h1>
