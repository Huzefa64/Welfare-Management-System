                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<!--- Teens and  Sunday school management------->
                         ...
                         <!--- Visitors management------->
                          ...
                          <!------/.* finance sidebar*------->
					    <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-money"></i>&nbsp;Givings/Donations
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs1" class="collapse">						
                            <li class="">
                            <a href="Tithes.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Donations Paid</a>
                            </li>
							<li class="">
                            <a href="addTithes.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Donations</a>
                            </li>
						    <li class="">
